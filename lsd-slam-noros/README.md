# TO GET GOOD INSTRUCTIONS FOR RUNNING - PLEASE PM ME AND IN THE PROCESS WE WILL UPDATE THIS README
so far they are

git clone https://github.com/smitherson/lsd-slam-noros

cd lsd-slam-noros/lsd_slam_core
...
you go to lsd-slam-noros/lsd_slam_viewer
...
then you need two terminals

in one of them you run lsd-slam-noros/lsd_slam_viewer/bin/viewer

in the other  you run lsd-slam-noros/lsd_slam_core/bin/live_slam [path ot video file]  [path to calibration file]


#Example calibration files are in: 

lsd-slam-noros/lsd_slam_core/calib/opencv_lgg3_640480.cfg

one row of four intrinsic parameters, four distortion parameters

one row with resolution

'crop'

resolution to crop

700.1441001496614 713.1370873930887 321.5265928650794 245.1270406206272 0 0 0 0 
