...
void KeyFrameGraphDisplay::addMsg(lsd_slam::keyframeMsgConstPtr msg)
{
	dataMutex.lock();
...
void KeyFrameGraphDisplay::addGraphMsg(lsd_slam::keyframeGraphMsgConstPtr msg)
{
	dataMutex.lock();
