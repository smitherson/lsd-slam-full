...
/* 
 * Starts slam system adding IO to it, has several simple callbacks.
 * newImageCallback is the one that does the interesting work.
 */
...
void LiveSLAMWrapper::Loop()
{
	while (true) {
		...
		//LOGI("Processing image! %d", image.timestamp);
